...
src = Tunnel.getInterface("vrp_animacoes",src)
-----------------------------------------------------------------------------------------------------------------------------------------
-- 60309 hand ESQUERDA
-- 28422 hand DIREITA
-- 50 NÃO REPETE
...
local animacoes = {
	...
	{ nome = "garcom" , dict = "anim@move_f@waitress" , anim = "idle" , prop = "prop_food_bs_tray_01", flag = 50 , hand = 28422 },
	{ nome = "garcom2" , dict = "anim@move_f@waitress" , anim = "idle" , prop = "prop_food_bs_tray_02", flag = 50 , hand = 28422 },
	{ nome = "garcom3" , dict = "anim@move_f@waitress" , anim = "idle" , prop = "prop_food_bs_tray_03", flag = 50 , hand = 28422 },
		...
		if src.checkItem() then
			...
			if closestPlayer ~= nil then
				TriggerServerEvent('cmg2_animations:sync', closestPlayer, lib,lib2, anim1, anim2, distans, distans2, height,target,length,spin,controlFlagMe,controlFlagTarget,animFlagTarget)
				 ...
				 TriggerClientEvent("Notify",source,"negado","Nenhum player proximo para ser <b>Carregado</b>")
			end
		else
...
RegisterCommand("cavalinho",function(source, args)
	if not piggyBackInProgress then
		...
		if closestPlayer ~= nil then
			...
			print("[Sintonia Roleplay] Nenhum jogador por perto")
		end
	else
