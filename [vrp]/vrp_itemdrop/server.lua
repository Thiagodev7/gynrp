...
-- WEBHOOK
-----------------------------------------------------------------------------------------------------------------------------------------
local webhookpegaritem = "https://discord.com/api/webhooks/1001361187302281299/Kbh79Pjmq8g4bje3jyt12NJhZZPxQa0GLJOWqRG9l1a-P-DlYGLnVC2KWENKFRghXw0u"
	...
	if nuser_id then
		...
		if user_id then
			if items[id] ~= nil then
				local new_weight = vRP.computeInvWeight(user_id)+vRP.itemWeightList(items[id].item)*items[id].count
