...
--			["WEAPON_FLASHLIGHT"] = {ammo=1}
	...
	elseif vRP.hasGroup(user_id,"PM1") then
		vRP.addUserGroup(user_id,"PM1Paycheck")
		TriggerEvent('eblips:add',{ name = "PM", src = player, color = 47 })
		vRPclient.giveWeapons(player,{
		},false,true)
		return true
	elseif vRP.hasGroup(user_id,"PM2") then
		vRP.addUserGroup(user_id,"PM2Paycheck")
		TriggerEvent('eblips:add',{ name = "PM", src = player, color = 47 })
		vRPclient.giveWeapons(player,{
		},false,true)
		return true
	elseif vRP.hasGroup(user_id,"PM3") then
		vRP.addUserGroup(user_id,"PM3Paycheck")
		TriggerEvent('eblips:add',{ name = "PM", src = player, color = 47 })
		vRPclient.giveWeapons(player,{
		},false,true)
		return true
	elseif vRP.hasGroup(user_id,"PM4") then
		vRP.addUserGroup(user_id,"PM4Paycheck")
		TriggerEvent('eblips:add',{ name = "PM", src = player, color = 47 })
		vRPclient.giveWeapons(player,{
		},false,true)
		return true
	elseif vRP.hasGroup(user_id,"PM5") then
		vRP.addUserGroup(user_id,"PM5Paycheck")
		TriggerEvent('eblips:add',{ name = "PM", src = player, color = 47 })
		vRPclient.giveWeapons(player,{
		},false,true)
		return true
	elseif vRP.hasGroup(user_id,"PM6") then
		vRP.addUserGroup(user_id,"PM6Paycheck")
		TriggerEvent('eblips:add',{ name = "PM", src = player, color = 47 })
		vRPclient.giveWeapons(player,{
		},false,true)
		return true
	elseif vRP.hasGroup(user_id,"PM7") then
		vRP.addUserGroup(user_id,"PM7Paycheck")
		TriggerEvent('eblips:add',{ name = "PM", src = player, color = 47 })
		vRPclient.giveWeapons(player,{
		},false,true)
		return true
	elseif vRP.hasGroup(user_id,"PM8") then
		vRP.addUserGroup(user_id,"PM8Paycheck")
		TriggerEvent('eblips:add',{ name = "PM", src = player, color = 47 })
		vRPclient.giveWeapons(player,{
		},false,true)
		return true
	elseif vRP.hasGroup(user_id,"PM9") then
		vRP.addUserGroup(user_id,"PM9Paycheck")
		TriggerEvent('eblips:add',{ name = "PM", src = player, color = 47 })
		vRPclient.giveWeapons(player,{
		},false,true)
		return true
	...
	elseif vRP.hasGroup(user_id,"rotam1") then
		vRP.addUserGroup(user_id,"rotam1Paycheck")
		TriggerEvent('eblips:add',{ name = "rotam", src = player, color = 47 })
		vRPclient.giveWeapons(player,{
		},false,true)
		return true
	elseif vRP.hasGroup(user_id,"rotam2") then
		vRP.addUserGroup(user_id,"rotam2Paycheck")
		TriggerEvent('eblips:add',{ name = "rotam", src = player, color = 47 })
		vRPclient.giveWeapons(player,{
		},false,true)
		return true
	elseif vRP.hasGroup(user_id,"rotam3") then
		vRP.addUserGroup(user_id,"rotam3Paycheck")
		TriggerEvent('eblips:add',{ name = "rotam", src = player, color = 47 })
		vRPclient.giveWeapons(player,{
		},false,true)
		return true
	elseif vRP.hasGroup(user_id,"rotam4") then
		vRP.addUserGroup(user_id,"rotam4Paycheck")
		TriggerEvent('eblips:add',{ name = "rotam", src = player, color = 47 })
		vRPclient.giveWeapons(player,{
		},false,true)
		return true
	elseif vRP.hasGroup(user_id,"rotam5") then
		vRP.addUserGroup(user_id,"rotam5Paycheck")
		TriggerEvent('eblips:add',{ name = "rotam", src = player, color = 47 })
		vRPclient.giveWeapons(player,{
		},false,true)
		return true
	elseif vRP.hasGroup(user_id,"rotam6") then
		vRP.addUserGroup(user_id,"rotam6Paycheck")
		TriggerEvent('eblips:add',{ name = "rotam", src = player, color = 47 })
		vRPclient.giveWeapons(player,{
		},false,true)
		return true
	elseif vRP.hasGroup(user_id,"rotam7") then
		vRP.addUserGroup(user_id,"rotam7Paycheck")
		TriggerEvent('eblips:add',{ name = "rotam", src = player, color = 47 })
		vRPclient.giveWeapons(player,{
		},false,true)
		return true
	elseif vRP.hasGroup(user_id,"rotam8") then
		vRP.addUserGroup(user_id,"rotam8Paycheck")
		TriggerEvent('eblips:add',{ name = "rotam", src = player, color = 47 })
		vRPclient.giveWeapons(player,{
		},false,true)
		return true
	elseif vRP.hasGroup(user_id,"rotam9") then
		vRP.addUserGroup(user_id,"rotam9Paycheck")
		TriggerEvent('eblips:add',{ name = "rotam", src = player, color = 47 })
		vRPclient.giveWeapons(player,{
		},false,true)
		return true
