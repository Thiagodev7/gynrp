...
RegisterNUICallback('hirePlayer', function(data, cb)
	if cooldown == nil then
		...
		TriggerServerEvent('vrp_stores:hirePlayer',key,data.user)
		SetTimeout(500,function()
			cooldown = nil
		end)
	end
...
RegisterNUICallback('firePlayer', function(data, cb)
	if cooldown == nil then
		cooldown = true
		local key = empresaAtual
		TriggerServerEvent('vrp_stores:firePlayer',key,data.user)
		SetTimeout(500,function()
			cooldown = nil
		end)
	end
...
RegisterNUICallback('changeRole', function(data, cb)
	local key = empresaAtual
	TriggerServerEvent('vrp_stores:changeRole',key,data.user_id,data.role)
end)
...
RegisterNUICallback('giveComission', function(data, cb)
	if cooldown == nil then
		cooldown = true
		local key = empresaAtual
		TriggerServerEvent('vrp_stores:giveComission',key,data.user,data.amount)
		SetTimeout(500,function()
			cooldown = nil
		end)
	end
...
RegisterNUICallback('hideBalance', function(data, cb)
	TriggerServerEvent('vrp_stores:hideBalance',empresaAtual,data)
end)

RegisterNUICallback('showBalance', function(data, cb)
	TriggerServerEvent('vrp_stores:showBalance',empresaAtual,data)
end)
