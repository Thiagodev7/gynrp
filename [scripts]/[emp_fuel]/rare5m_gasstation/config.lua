...
Config.webhook = "https://discord.com/api/webhooks/931282280100552714/ssCePAXU_fGtOC6nSwFXz9kFLDuM9T99zQJCLPSnlz2fAui86q9000yvC9bGWJjZl9Ui"						-- Webhook to send logs to discord
...
Config.format = {
	['currency'] = 'BRL',						-- This is the currency format, so that your currency symbol appears correctly [Examples: BRL, USD]
...
Config.max_stations_per_player = 2				-- Maximum number of stores that each player can have
...
Config.gas_station_locations = {
	["gas_station_1"] = {										-- ID
		['buy_price'] = 1000000,									-- Price to buy this gas station
		['sell_price'] = 500000,								-- Price to sell this gas station
	...
	["gas_station_3"] = {
		...
		['trailer_coord'] = {1181.87, -1413.02, 34.27,273.02},
...
Config.gas_station_types = {
	['small_gas_station'] = {					-- Gas station type ID
		...
		['max_gas_price'] = 30,					-- Maximum price that the owner can apply
		...
		['blips'] = {							-- Create the blips on the map
			...
			['name'] = "Posto de Gasolina",			-- Blip Name
			['color'] = 41,						-- Blip Color
