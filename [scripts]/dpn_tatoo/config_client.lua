...
Config_client = {
    ...
    ['partsM'] = {
        ...
        rightarm = {
            tattoo = {
                ...
                {name = 'MP_Christmas2017_Tattoo_006_M', cname = 'Medusa', part = 'mpchristmas2017_overlays'},
    ...
    ['partsF'] = {
        ...
        leftarm = {
            ...
            tattoo = {
                {name = 'MP_Airraces_Tattoo_003_F', cname = 'Toxic Trails', part = 'mpairraces_overlays'},                
