        ...
        if cfg.dependencys() then
            ...
            if IsEntityDead(ped) then
                ...
                if GetPedCauseOfDeath(ped) ~= 0 and cooldown == 0 then
                    ...
                    TriggerServerEvent("gArmasPlayerDeath")
...
RegisterNetEvent("mirtin_survival:updateTime")

AddEventHandler("mirtin_survival:updateTime", function(time) 
...
RegisterNetEvent("mirtin_survival:setHud")

AddEventHandler("mirtin_survival:setHud", function(boolean) 
