				...
				if not inProgress[src] then
					if item == "ahk" then
						if vRP.getInventoryWeight(user_id)+vRP.getItemWeight("wbody|WEAPON_SNSPISTOL") <= vRP.getInventoryMaxWeight(user_id) then
							if vRP.getInventoryItemAmount(user_id,"pecadearma") >= 4 then
								if vRP.getInventoryItemAmount(user_id,"placademetal") >= 4 then
									if vRP.getInventoryItemAmount(user_id,"gatilho") >= 1 then
										if vRP.getInventoryItemAmount(user_id,"mola") >= 1 then
											if vRP.tryGetInventoryItem(user_id,"pecadearma",4) and vRP.tryGetInventoryItem(user_id,"placademetal",4) and vRP.tryGetInventoryItem(user_id,"gatilho",1) and vRP.tryGetInventoryItem(user_id,"mola",1) then
					...
					elseif item == "five" then
						if vRP.getInventoryWeight(user_id)+vRP.getItemWeight("wbody|WEAPON_PISTOL_MK2") <= vRP.getInventoryMaxWeight(user_id) then
							if vRP.getInventoryItemAmount(user_id,"pecadearma") >= 6 then
								if vRP.getInventoryItemAmount(user_id,"placademetal") >= 6 then
									if vRP.getInventoryItemAmount(user_id,"gatilho") >= 1 then
										if vRP.getInventoryItemAmount(user_id,"mola") >= 2 then
											if vRP.tryGetInventoryItem(user_id,"pecadearma",6) and vRP.tryGetInventoryItem(user_id,"placademetal",6) and vRP.tryGetInventoryItem(user_id,"gatilho",1) and vRP.tryGetInventoryItem(user_id,"mola",2) then
												TriggerClientEvent("progress",src,1000,"fazendo")
												vRPclient._playAnim(src,false,{{"amb@prop_human_parking_meter@female@idle_a","idle_a_female"}},true)
												inProgress[src] = true
												TriggerClientEvent("F6Cancel",src,true)
								...
								if vRP.getInventoryItemAmount(user_id,"placademetal") >= 8 then
									if vRP.getInventoryItemAmount(user_id,"gatilho") >= 2 then
										if vRP.getInventoryItemAmount(user_id,"mola") >= 3 then
											if vRP.tryGetInventoryItem(user_id,"pecadearma",4) and vRP.tryGetInventoryItem(user_id,"placademetal",8) and vRP.tryGetInventoryItem(user_id,"gatilho",2) and vRP.tryGetInventoryItem(user_id,"mola",3) then
												TriggerClientEvent("progress",src,1000,"fazendo")
												vRPclient._playAnim(src,false,{{"amb@prop_human_parking_meter@female@idle_a","idle_a_female"}},true)
												inProgress[src] = true
												TriggerClientEvent("F6Cancel",src,true)
								...
								if vRP.getInventoryItemAmount(user_id,"placademetal") >= 10 then
									if vRP.getInventoryItemAmount(user_id,"gatilho") >= 2 then
										if vRP.getInventoryItemAmount(user_id,"mola") >= 4 then
											if vRP.tryGetInventoryItem(user_id,"pecadearma",6) and vRP.tryGetInventoryItem(user_id,"placademetal",10) and vRP.tryGetInventoryItem(user_id,"gatilho",2) and vRP.tryGetInventoryItem(user_id,"mola",4) then
												TriggerClientEvent("progress",src,1000,"fazendo")
												vRPclient._playAnim(src,false,{{"amb@prop_human_parking_meter@female@idle_a","idle_a_female"}},true)
												inProgress[src] = true
												TriggerClientEvent("F6Cancel",src,true)
					...
					elseif item == "famas" then
						if vRP.getInventoryWeight(user_id)+vRP.getItemWeight("wbody|WEAPON_BULLPUPRIFLE") <= vRP.getInventoryMaxWeight(user_id) then
							if vRP.getInventoryItemAmount(user_id,"pecadearma") >= 4 then
								if vRP.getInventoryItemAmount(user_id,"placademetal") >= 12 then
									if vRP.getInventoryItemAmount(user_id,"gatilho") >= 3 then
										if vRP.getInventoryItemAmount(user_id,"mola") >= 4 then
											if vRP.tryGetInventoryItem(user_id,"pecadearma",4) and vRP.tryGetInventoryItem(user_id,"placademetal",12) and vRP.tryGetInventoryItem(user_id,"gatilho",3) and vRP.tryGetInventoryItem(user_id,"mola",4) then
												TriggerClientEvent("progress",src,1000,"fazendo")
												vRPclient._playAnim(src,false,{{"amb@prop_human_parking_meter@female@idle_a","idle_a_female"}},true)
												inProgress[src] = true
												TriggerClientEvent("F6Cancel",src,true)
					...
					elseif item == "ak47" then
						if vRP.getInventoryWeight(user_id)+vRP.getItemWeight("wbody|WEAPON_ASSAULTRIFLE") <= vRP.getInventoryMaxWeight(user_id) then
							if vRP.getInventoryItemAmount(user_id,"pecadearma") >= 6 then
								if vRP.getInventoryItemAmount(user_id,"placademetal") >= 14 then
									if vRP.getInventoryItemAmount(user_id,"gatilho") >= 3 then
										if vRP.getInventoryItemAmount(user_id,"mola") >= 5 then
											if vRP.tryGetInventoryItem(user_id,"pecadearma",6) and vRP.tryGetInventoryItem(user_id,"placademetal",14) and vRP.tryGetInventoryItem(user_id,"gatilho",3) and vRP.tryGetInventoryItem(user_id,"mola",5) then
												TriggerClientEvent("progress",src,1000,"fazendo")
												vRPclient._playAnim(src,false,{{"amb@prop_human_parking_meter@female@idle_a","idle_a_female"}},true)
												inProgress[src] = true
												TriggerClientEvent("F6Cancel",src,true)
					...
					elseif item == "akm" then
						if vRP.getInventoryWeight(user_id)+vRP.getItemWeight("wbody|WEAPON_ASSAULTRIFLE_MK2") <= vRP.getInventoryMaxWeight(user_id) then
							if vRP.getInventoryItemAmount(user_id,"pecadearma") >= 8 then
								if vRP.getInventoryItemAmount(user_id,"placademetal") >= 17 then
									if vRP.getInventoryItemAmount(user_id,"gatilho") >= 3 then
										if vRP.getInventoryItemAmount(user_id,"mola") >= 6 then
											if vRP.tryGetInventoryItem(user_id,"pecadearma",8) and vRP.tryGetInventoryItem(user_id,"placademetal",17) and vRP.tryGetInventoryItem(user_id,"gatilho",3) and vRP.tryGetInventoryItem(user_id,"mola",6) then
												TriggerClientEvent("progress",src,1000,"fazendo")
												vRPclient._playAnim(src,false,{{"amb@prop_human_parking_meter@female@idle_a","idle_a_female"}},true)
												inProgress[src] = true
												TriggerClientEvent("F6Cancel",src,true)
					...
					elseif item == "g36" then
						if vRP.getInventoryWeight(user_id)+vRP.getItemWeight("wbody|WEAPON_SPECIALCARBINE") <= vRP.getInventoryMaxWeight(user_id) then
							if vRP.getInventoryItemAmount(user_id,"pecadearma") >= 10 then
								if vRP.getInventoryItemAmount(user_id,"placademetal") >= 20 then
									if vRP.getInventoryItemAmount(user_id,"gatilho") >= 3 then
										if vRP.getInventoryItemAmount(user_id,"mola") >= 7 then
											if vRP.tryGetInventoryItem(user_id,"pecadearma",10) and vRP.tryGetInventoryItem(user_id,"placademetal",20) and vRP.tryGetInventoryItem(user_id,"gatilho",3) and vRP.tryGetInventoryItem(user_id,"mola",7) then
												TriggerClientEvent("progress",src,1000,"fazendo")
												vRPclient._playAnim(src,false,{{"amb@prop_human_parking_meter@female@idle_a","idle_a_female"}},true)
												inProgress[src] = true
												TriggerClientEvent("F6Cancel",src,true)
