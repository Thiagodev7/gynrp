...
config.groups = {
    ...
    ["pm"] = {
        ...
        [3] = { onService = "PM9", outService = "PM9Paycheck" },
        [4] = { onService = "PM8", outService = "PM8Paycheck" },
        [5] = { onService = "PM7", outService = "PM7Paycheck" },
        [6] = { onService = "PM6", outService = "PM6Paycheck" },
        [7] = { onService = "PM5", outService = "PM5Paycheck" },
        [8] = { onService = "PM4", outService = "PM4Paycheck" },
        [9] = { onService = "PM3", outService = "PM3Paycheck" },
        [10] = { onService = "PM2", outService = "PM2Paycheck" },
        [11] = { onService = "PM1", outService = "PM1Paycheck" },
    },
    ["rocam"] = {
    ...
    ["rotam"] = {
        [1] = { onService = "rotam9", outService = "rotam9Paycheck" },
        [2] = { onService = "rotam8", outService = "rotam8Paycheck" },
        [3] = { onService = "rotam7", outService = "rotam7Paycheck" },
        [4] = { onService = "rotam6", outService = "rotam6Paycheck" },
        [5] = { onService = "rotam5", outService = "rotam5Paycheck" },
        [6] = { onService = "rotam4", outService = "rotam4Paycheck" },
        [7] = { onService = "rotam3", outService = "rotam3Paycheck" },
        [8] = { onService = "rotam2", outService = "rotam2Paycheck" },
        [9] = { onService = "rotam1", outService = "rotam1Paycheck" },
    },
    ["eb"] = {
    ...
    ["Mendanha"] = {
        [1] = { onService = "Lider-Mendanha", outService = "Lider-Mendanha" },
        [2] = { onService = "Mendanha2", outService = "Mendanha2" },
        [3] = { onService = "Mendanha1", outService = "Mendanha1" },
    },
    ["anonymous"] = {
    ...
    ["Iraque"] = {
        [1] = { onService = "Lider-Iraque", outService = "Lider-Iraque" },
        [2] = { onService = "Iraque2", outService = "Iraque2" },
        [3] = { onService = "Iraque1", outService = "Iraque1" },
    },
    ["vanilla"] = {
    ...
    ["Comando Vermelho"] = {
        [1] = { onService = "Lider-CV", outService = "Lider-CV" },
        [2] = { onService = "CV2", outService = "CV2" },
        [3] = { onService = "CV1", outService = "CV1" },
    },
    ["bahamas"] = {
        [1] = { onService = "Lider-Bahamas", outService = "Lider-Bahamas" },
        [2] = { onService = "Bahamas2", outService = "Bahamas2" },
        [3] = { onService = "Bahamas1", outService = "Bahamas1" },
    },
}
